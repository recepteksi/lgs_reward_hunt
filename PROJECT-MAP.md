...
**GENERATED — do not edit.** `dart run tool/generate_project_map.dart` rewrites it; `dart run tool/check_structure.dart` fails while it is stale. Rules: [CLAUDE.md](CLAUDE.md). 462 source files.
